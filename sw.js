const CACHE_NAME = "cancionero-tuna-derecho-v43";
...
self.addEventListener("install", (event) => {
  event.waitUntil((async () => {
    ...
    const fresh = await fetch('/?app-shell=v43', { cache: 'no-store' });
...
self.addEventListener("activate", (event) => {
  event.waitUntil((async () => {
    ...
    // Fuerza a las ventanas abiertas a volver a cargar usando el shell v43.
